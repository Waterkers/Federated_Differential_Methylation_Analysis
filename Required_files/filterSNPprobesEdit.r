...
filterSNPprobesEdit<-function(betas, population = "EUR", maf = 0.05){
	snpProbes <- read.table('/home/silke/Documents/FedEWAS/Federated_Differential_Methylation_Analysis/Required_files/mmc1.txt', header = TRUE) #url("https://pmc.ncbi.nlm.nih.gov/articles/instance/4909830/bin/mmc1.txt")
