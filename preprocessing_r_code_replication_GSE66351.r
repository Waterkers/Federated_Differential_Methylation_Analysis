...
if(!dir.exists("QC_GSE66351")){
  dir.create("QC_GSE66351")
}
if(!dir.exists("QC_GSE66351/Plots")){
  dir.create("QC_GSE66351/Plots")
}
#### import the data using methylumi -> create a MethyLumiSet object
# loading in actual data - GSE66351
pheno1 <- read.table("/home/rstudio/GSE66351_RAW/GSE66351_pheno_info.txt")
...
pheno1 <- pheno1[2:191,]
Sample_ID <- getBarcodes("/home/rstudio/GSE66351_RAW/GSE66351")
...
pdf("QC_GSE66351/Plots/Sample_Intensity_histogram.pdf")
par(mfrow = c(1,2))
...
# of samples provided
pdf("QC_GSE66351/Plots/Sample_Intensity_ByPlate_boxplot.pdf")
par(mfrow = c(1,2))
par(mar = c(8, 4, 1, 1))
...
# pdf("QC_GSE66351/Plots/Sample_Intensity_ByPlate_histogram.pdf")
# nCol<-length(unique(pheno$plate))## assumes there is a column called Plate in your phenotype file
...
pdf("QC_GSE66351/Plots/Bisulphite_Conversion.pdf")
...
pdf("QC_GSE66351/Plots/Gender_Cluster.pdf")
...
pdf("QC_GSE66351/Plots/Betas_raw_boxplot.pdf")
...
annotation_data <- read.csv("/home/rstudio/GSE66351_RAW/GPL13534_HumanMethylation450_15017482_v.1.1_edit.csv", header = TRUE)
...
pdf("QC_GSE66351/Plots/Betas_normalized_boxplot.pdf")
...
pdf("QC_GSE66351/Plots/Celltype_estimates_barplot.pdf")
...
# save everything
save(Betas, Small_Pheno, file = "QC_GSE66351/GSE66351_Preprocessed_CTD.RData")
save(Full_Pheno, file = "QC_GSE66351/GSE66351_Full_Phenotype_Information.RData")

write.csv(Betas, file = "QC_GSE66351/GSE66351_Preprocessed_CTD_Betas.csv")
write.csv(Small_Pheno, file = "QC_GSE66351/GSE66351_Reduced_Pheno_Info.csv")
write.csv(Full_Pheno, file = "QC_GSE66351/GSE66351_Full_Pheno_Info.csv")
