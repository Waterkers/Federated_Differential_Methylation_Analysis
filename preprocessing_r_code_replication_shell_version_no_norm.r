...
if(!dir.exists(sprintf("QC_GSE66351_PythonShell\\Plots"))){
  dir.create(sprintf("QC_GSE66351_PythonShell\\Plots"))
} 
...
save(msetEPIC.pf, file = "QC_GSE66351_PythonShell\\preprocessed_MethyLumiSet.RData")
...
write.csv(QCmetrics, "QC_GSE66351_PythonShell/pre_norm_pheno_information.csv")
